...
import { 
    ...
    DarkMode as DarkModeIcon, LightMode as LightModeIcon, Translate as TranslateIcon 
                ...
                <Paper elevation={24} sx={{ 
                    ...
                    <Box sx={{ mb: 4, textAlign: 'center' }}>
                        ...
                        <Typography variant="body2" sx={{ color: 'text.secondary', fontWeight: 500 }}>
                            {t('Collaborative Task Management')}
                        </Typography>
                    </Box>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <Box sx={{ mt: 4, textAlign: 'center' }}>
                            <Typography variant="body2" sx={{ color: 'text.secondary', fontWeight: 500 }}>
                                ...
                                <Link component={RouterLink} to="/signup" sx={{ fontWeight: 800, color: 'primary.main', textDecoration: 'none', '&:hover': { textDecoration: 'underline' } }}>
                                    {t('Sign Up')}
                                </Link>
                            </Typography>
                        </Box>
